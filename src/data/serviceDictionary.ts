...
import { Globe, Mail, Cloud, Users, Tv, ShoppingCart, Gamepad2 } from 'lucide-react';
import { FaAws, FaMicrosoft, FaYahoo, FaLinkedin, FaAmazon, FaXbox } from 'react-icons/fa';
import {
  SiGithub,
  SiGitlab,
  SiBitbucket,
