            ...
            <div className="flex flex-col items-center mt-8">
              <div className="flex items-center justify-center space-x-3 mb-2">
                ...
                >
                  ...
                  <path
                    d="M98.1333 181.941C91.2026 181.941 87 177.665 87 170.366V85.5757C87 78.2764 91.1289 74 98.1333 74H130.575C155.053 74 169.062 86.9028 169.062 107.916C169.062 121.188 162.5 132.542 150.777 137.556L166.113 164.099C167.956 167.269 168.472 169.186 168.472 171.767C168.472 177.665 163.753 181.941 157.265 181.941C151.957 181.941 149.523 180.024 145.911 173.536L128.215 141.463H109.267V170.366C109.267 177.665 105.138 181.941 98.1333 181.941ZM109.267 125.316H128.437C139.644 125.316 146.206 118.902 146.206 108.358C146.206 98.0361 139.275 91.4004 128.215 91.4004H109.267V125.316Z"
                    fill="#F9FAFB"
                  />
                </svg>
